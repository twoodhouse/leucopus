...
// 	midLink := pth.AddLinkFromLinks(pth.EntryLinks, truthTable.New([]int{0, 0, 0, 1}), false)
// 	ILink := pth.AddLinkFromLinks([]*truthTable.Link{midLink}, truthTable.New([]int{0, 1}), true)
// 	midLinkR := pth.AddLinkFromLinks([]*truthTable.Link{ILink}, truthTable.New([]int{0, 1}), false)
// 	truthTable.AttachLinks(midLinkR, pth.ExitLink, 0)
//
...
// 	midLinkR2 := pth2.AddLinkFromLinks([]*truthTable.Link{ILink2}, truthTable.New([]int{0, 1}), false)
// 	truthTable.AttachLinks(midLinkR2, pth2.ExitLink, 0)
//
...
// 	midLinkR3 := pth3.AddLinkFromLinks([]*truthTable.Link{ILink3}, truthTable.New([]int{0, 1}), false)
// 	truthTable.AttachLinks(midLinkR3, pth3.ExitLink, 0)
//
// 	mem.Paths[info1] = pth
...
func TestAssumeBestRiverTest(t *testing.T) {
	println("Assume Best River test 1")
	mem := New()
	info1 := info.New("i1", "")
	info2 := info.New("i2", "")
	info3 := info.New("i3", "")
	...
	pth := pather.NewPath([]*info.Info{info2, info3})
	midLink := pth.AddLinkFromLinks(pth.EntryLinks, truthTable.New([]int{2, 2, 2, 2}), false)
	ILink := pth.AddLinkFromLinks([]*truthTable.Link{midLink}, truthTable.New([]int{0, 1}), true)
	midLinkR := pth.AddLinkFromLinks([]*truthTable.Link{ILink}, truthTable.New([]int{2, 2}), false)
	truthTable.AttachLinks(midLinkR, pth.ExitLink, 0)

	pth2 := pather.NewPath([]*info.Info{info2, info3})
	midLink2 := pth2.AddLinkFromLinks(pth2.EntryLinks, truthTable.New([]int{2, 2, 2, 2}), false)
	ILink2 := pth2.AddLinkFromLinks([]*truthTable.Link{midLink2}, truthTable.New([]int{0, 1}), true)
	midLinkR2 := pth2.AddLinkFromLinks([]*truthTable.Link{ILink2}, truthTable.New([]int{2, 2}), false)
	truthTable.AttachLinks(midLinkR2, pth2.ExitLink, 0)

	pth3 := pather.NewPath([]*info.Info{info2, info3})
	midLink3 := pth3.AddLinkFromLinks(pth3.EntryLinks, truthTable.New([]int{2, 2, 2, 2}), false)
	ILink3 := pth3.AddLinkFromLinks([]*truthTable.Link{midLink3}, truthTable.New([]int{0, 1}), true)
	midLinkR3 := pth3.AddLinkFromLinks([]*truthTable.Link{ILink3}, truthTable.New([]int{2, 2}), false)
	truthTable.AttachLinks(midLinkR3, pth3.ExitLink, 0)
